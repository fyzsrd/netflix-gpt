    ...
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <div className="absolute p-12 bg-black/75 w-full max-w-md my-24 mx-auto right-0 left-0 rounded-md text-white">
        ...
        <form className="flex flex-col gap-4 ">
          ...
          {!signInCodeMode && <p className='text-center text-0.5'>Message and data rates may apply</p>}
          ...
          <button className="bg-[#333] font-bold p-3 rounded-md mt-1 hover:bg-[#333]/89 transition-colors cursor-pointer"
          onClick={signInCode}
          >
            {signInCodeMode ? 'Sign In using a code' : ' Use Password'}
          </button>
          <p className='text-center underline cursor-pointer hover:text-white/75'>forgot email or password?</p>
        ...
        <div className="mt-12 text-gray-400">
          ...
          <span href="#" className="text-blue-500 underline ml-1">Learn more.</span>
        </div>
      </div>
    </div>
  )
